...
//https://www.amozeshgam.ir
//آموزشگام | مرجع آموزش های گام به گام در زمینه های مختلف
// این کلاس مسئول بازگردانی تاریخ شمسی و ساعت کنونی میباشد
class PersianDate {
    ...
    private fun setDateCalendar() {
        // کلاس Date مربوط به java.util.Date است و یک شیء از تاریخ و زمان فعلی ایجاد می‌کند.
        val date = Date()
        val ld: Int
        // این کلاس بر اساس تقویم میلادی (Gregorian Calendar) کار می‌کند
        // و امکان انجام عملیات روی تاریخ و زمان را فراهم می‌کند.
        val calendar = GregorianCalendar()
        // درواقع calendar حالا تاریخ و ساعت فعلی سیستم را نگه می‌دارد.
        calendar.time = date
